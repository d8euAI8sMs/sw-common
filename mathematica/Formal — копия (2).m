...
EnableFeature[Formatter[Tensor]]:=Module[{$fmt},
	Tensor/:MakeBoxes[Tensor[g_,cont_,cov_][idx__],StandardForm]:=Module[{},
		SubsuperscriptBox[If[AtomQ[g],ToBoxes[g],RowBox[{"(",ToBoxes[g],")"}]],RowBox[Table[ToBoxes[{idx}[[cov[[v]]]]],{v,Length[cov]}]],RowBox[Table[ToBoxes[{idx}[[cont[[v]]]]],{v,Length[cont]}]]]
	];
...
TensorMapHelper[k1_ e:SSum[__] k2_,r_] := TensorMapHelper[k1,r] TensorMapHelper[e,r] TensorMapHelper[k2,r];
